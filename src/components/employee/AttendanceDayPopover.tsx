...
export const AttendanceDayPopover: React.FC<AttendanceDayPopoverProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Popover Card */}
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden animate-slide-up border border-slate-100 z-10">
        {/* Header */}
        ...
        <div className="p-5 space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <span className="text-xs font-semibold text-slate-500">Log Status</span>
          ...
          <div className="p-3 bg-teal-50/50 rounded-xl border border-teal-100/80 flex items-center justify-between">
            <span className="text-xs font-semibold text-teal-800 flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-teal-600" /> Total Duration
            </span>
